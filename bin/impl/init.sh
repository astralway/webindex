...
mvn dependency:get -Dartifact=io.fluo:fluo-recipes-core:1.0.0-beta-1:jar -Ddest=$FLUO_APP_LIB
mvn dependency:get -Dartifact=io.fluo:fluo-recipes-accumulo:1.0.0-beta-1:jar -Ddest=$FLUO_APP_LIB
