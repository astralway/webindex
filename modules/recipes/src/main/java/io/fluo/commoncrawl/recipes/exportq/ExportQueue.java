...
public abstract class ExportQueue<K, V> {
  ...
  public static void setConfiguration(Configuration appConfig, String queueId, ExportQueueOptions opts) {
  ...
  public void add(TransactionBase tx, K key, V value) {
    ...
    //hash the hash for the case where numBuckets == numCounters... w/o hashing the hash there would only be 1 counter per bucket in this case
