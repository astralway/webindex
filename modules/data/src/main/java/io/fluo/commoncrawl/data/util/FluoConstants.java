...
public class FluoConstants {
  ...
  public static final Column PAGE_INCOUNT_COL = new Column(ColumnConstants.PAGE, ColumnConstants.INCOUNT);
  public static final Column PAGE_SCORE_COL = new Column(ColumnConstants.PAGE, ColumnConstants.SCORE);
